...
## Installation (non Mac App Store version)
    ...
    git clone git@github.com:zenangst/Ruby.mode
...
If you want to get the latest updates, you simply run git pull inside the Modes directory
    ...
    cd ~/Library/Application\ Support/Coda\ 2/Modes/Ruby.mode
    git pull
    
Or the following if you are running the sandboxed MAS version.

    cd ~/Library/Containers/com.panic.Coda2/Data/Library/Application\ Support/Coda\ 2/Modes/Ruby.mode
    git pull
